...
class ParasiteReportController extends Controller
{
    public function select(Request $request)
    {
        if (Auth::user()->permission == 1) {
            ...
            return view('admin.report.parasite.select', compact('farms', 'communityCats'));
        } else {
    ...
    public function excel($farmId, $communityCatId)
    {
        ...
        return Excel::download(new ParasiteExport($farm, $farm_id), 'Parasite.xlsx');
    }
