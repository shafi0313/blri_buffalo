                            ...
                            <form action="{{ route('disease-and-treatment.store')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12" style="display:none" id="clinical_sing_cust_div">
                                        ...
                                        <input type="text" id="" class="form-control @error('clinical_sign_input') is-invalid @enderror" name="clinical_sign_input" value="{{old('clinical_sign_input')}}">
                                    </div>

                                   <div class="form-group col-md-3">
                                        <label for="symptom_date">Symptom/Sign Visible Date <span class="t_r">*</span></label>
                                        <input type="date" id="symptom_date" class="form-control @error('symptom_date') is-invalid @enderror" name="symptom_date" value="{{old('symptom_date')}}">
                                        @error('symptom_date')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
...
<script>
    ...
    $("#disease_date").on('change', function(){
        var sessionBirthCal;
        var sessionBody = new Date($("#disease_date").val()).getMonth()+1;
