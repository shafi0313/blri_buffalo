                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <select name="farmOrCommunityId" id="farm"
                                                ...
                                                @foreach ($farms as $farm)
                                                    <option value="{{ $farm->id }}f"
                                                        {{ $data->farm_id == $farm->id ? 'selected' : '' }}>{{ $farm->name }}
                                                    </option>
                                                @endforeach
                                                @foreach ($communityCats as $communityCat)
                                                    <option value="{{ $communityCat->id }}c"
                                                        {{ $data->community_cat_id == $farm->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select name="animal_info_id" id="animal_info"
                                                class="form-control select2 @error('animal_info_id') is-invalid @enderror">
                                            </select>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select name="bull_id" id="bull_id"
                                                class="form-control select2 @error('bull_id') is-invalid @enderror">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input name="date_of_service" type="date" id="date_of_service"
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select name="natural"
                                                ...
                                                <option value="Natural" {{ $data->natural == 'Natural' ? 'selected' : '' }}>
                                                    Natural</option>
