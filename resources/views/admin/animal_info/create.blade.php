                            ...
                            <form action="{{ route('animal-info.store')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="identification_no" type="text" class="form-control identificationNoFarm @error('identification_no') is-invalid @enderror" readonly required>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="animal_tag" type="text" class="form-control @error('animal_tag') is-invalid @enderror">
                                        @error('animal_tag')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row"> --}}
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="color" class="form-control">
                                            ...
                                            <option value="Zet black">Zet black</option>
