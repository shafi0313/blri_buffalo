<table id="multi-filter-select" class="display table table-striped table-hover" >
    ...
    <tbody>
        ...
        <tr class="text-center">
            ...
            <td>{{ number_format($milkProduction->where('animal_info_id',$reproduction->animal_info_id )->sum('milk_production') / $milkProduction->where('animal_info_id',$reproduction->animal_info_id)->count(),2) }}</td>
            @else
            <th></th>
            @endif
