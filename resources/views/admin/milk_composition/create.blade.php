                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3 ind " style="display: none">
                                            ...
                                            <select name="farmOrCommunityId" id="farm"
                                                class="form-control ind_val @error('community_cat_id') is-invalid @enderror select2">
                                                <option selected>Select</option>
                                                @foreach ($farms as $farm)
                                                    <option value="{{ $farm->id }}f">{{ $farm->name }}</option>
                                                @endforeach
                                                @foreach ($communityCats as $communityCat)
                                                    <option value="{{ $communityCat->id }}c">{{ $communityCat->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-3 subFarmDiv" style="display: none">
                                            ...
                                            <select name="community_id" id="subFarm"
                                                class="form-control valReset select2"></select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="production">Milk Production (kg) <span
                                                    class="t_r">*</span></label>
                                            <input name="production" type="number" step="any"
                                                class="form-control @error('production') is-invalid @enderror"
                                                value="{{ old('production') }}" required>
                                            @error('production')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input name="fat" type="number" step="any"
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input name="density" type="number" step="any"
                                                class="form-control @error('density') is-invalid @enderror"
                                                value="{{ old('density') }}" required>
                                            @error('density')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input name="lactose" type="number" step="any"
                                                class="form-control @error('lactose') is-invalid @enderror"
                                                value="{{ old('lactose') }}" required>
                                            @error('lactose')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input name="snf" type="number" step="any"
                                                class="form-control @error('snf') is-invalid @enderror"
                                                value="{{ old('snf') }}" required>
                                            @error('snf')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input name="protein" type="number" step="any"
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input name="water" type="number" step="any"
                                                class="form-control @error('water') is-invalid @enderror"
                                                value="{{ old('water') }}" required>
                                            @error('water')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="freezing_point">Freezing Point <span
                                                    class="t_r">*</span></label>
                                            <input name="freezing_point" type="number" step="any"
                                                class="form-control @error('freezing_point') is-invalid @enderror"
                                                value="{{ old('freezing_point') }}" required>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input name="salt" type="number" step="any"
