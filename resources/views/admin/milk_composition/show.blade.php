                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{route('milk-composition.create')}}" class="btn btn-primary btn-round ml-auto text-light"><i class="fa fa-plus"></i> Add New</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="multi-filter-select" class="display table table-striped table-hover" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            <td>{{ $x++ }} </td>
                                            <td>{{ $milkComposition->farm ? $milkComposition->farm->name : $milkComposition->communityCat->name}} </td>
