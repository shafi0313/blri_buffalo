                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    @if (request()->routeIs('body-weight.index'))
                                        <a href="{{ route('bodyWeight.exportIntoPdf') }}" class="btn btn-round ml-auto"><img
                                                src="{{ asset('files/images/icon/pdf.png') }}" alt="PDF Logo">
                                            PDF</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="{{ route('bodyWeight.exportIntoExcel') }}" class="btn btn-round"><img
                                        ...
                                        <a href="{{ route('body-weight.create') }}"
                                            ...
                                            New</a>
                                    @else
                                        <a href="{{ route('report.bodyWeight.pdf', [$productionRecords->first()->farm_id ?? 0, $productionRecords->first()->community_cat_id ?? 0]) }}"
                                            class="btn btn-round ml-auto"><img
                                                src="{{ asset('files/images/icon/pdf.png') }}" alt="PDF Logo">
                                            PDF</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="{{ route('report.bodyWeight.excel', [$productionRecords->first()->farm_id ?? 0, $productionRecords->first()->community_cat_id ?? 0]) }}"
                                            class="btn btn-round"><img src="{{ asset('files/images/icon/excel.png') }}"
                                                alt="Excel Logo"> Excel</a>&nbsp;&nbsp;
                                    @endif
                                </div>
                                <div class="formula">
                                    <span>Body wt. (Kg): <b>Day or Month - Birth Weight / Day</b></span>                                
                                </div>
                            </div>
