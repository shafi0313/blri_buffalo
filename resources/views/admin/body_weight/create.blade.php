                            ...
                            <form action="{{ route('body-weight.store')}}" method="post">
                                ...
                                {{--
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="animal_info_id" id="animalInfo" class="form-control @error('animal_info_id') is-invalid @enderror" required>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="date_d_0">Body date</label>
                                        <input type="date" class="form-control @error('date_d_0') is-invalid @enderror" name="date_d_0" id="date_d_0">
                                        @error('date_d_0')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="day_0">Body wt. (kg)</label>
                                        <input type="number" step="any" class="form-control @error('day_0') is-invalid @enderror" name="day_0" id="day_0">
                                        @error('day_0')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="any" class="form-control @error('day_15') is-invalid @enderror" name="day_15" id="day_15" >
                                        @error('day_15')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="any" class="form-control @error('month_18') is-invalid @enderror" name="month_18" id="month_18">
                                        @error('month_18')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="any" class="form-control @error('month_24') is-invalid @enderror" name="month_24" id="month_24">
                                        @error('month_24')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="any" class="form-control @error('month_30') is-invalid @enderror" name="month_30" id="month_30">
                                        @error('month_30')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="any" class="form-control @error('month_36') is-invalid @enderror" name="month_36" id="month_36">
                                        @error('month_36')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="any" class="form-control @error('month_42') is-invalid @enderror" name="month_42" id="month_42">
                                        @error('month_42')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" step="any" class="form-control @error('month_48') is-invalid @enderror" name="month_48" id="month_48">
                                        @error('month_48')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
            ...
            success:function (res) {
                ...
                if(
                   ...
                   empty(res.month_12)
                    ...
                    $('#day_0').focus();
                }else if(res.day_0 && empty(res.day_15)){
                    $('#day_15').focus();
                }else if(res.day_0 && res.day_15 && empty(res.month_1)){
                    $('#month_1').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && empty(res.month_2)){
                    $('#month_2').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && empty(res.month_3)){
                    $('#month_3').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && res.month_3 && empty(res.month_4)){
                    $('#month_4').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && res.month_3 && res.month_4 && empty(res.month_5)){
                    $('#month_5').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && res.month_3 && res.month_4 && res.month_5 && empty(res.month_6)){
                    $('#month_6').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && res.month_3 && res.month_4 && res.month_5 && res.month_6 && empty(res.month_7)){
                    $('#month_7').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && res.month_3 && res.month_4 && res.month_5 && res.month_6 && res.month_7 && empty(res.month_8)){
                    $('#month_8').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && res.month_3 && res.month_4 && res.month_5 && res.month_6 && res.month_7 && res.month_8 && empty(res.month_9)){
                    $('#month_9').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && res.month_3 && res.month_4 && res.month_5 && res.month_6 && res.month_7 && res.month_8 && res.month_9 && empty(res.month_10)){
                    $('#month_10').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && res.month_3 && res.month_4 && res.month_5 && res.month_6 && res.month_7 && res.month_8 && res.month_9 && res.month_10 && empty(res.month_11)){
                    $('#month_11').focus();
                }else if(res.day_0 && res.day_15 && res.month_1 && res.month_2 && res.month_3 && res.month_4 && res.month_5 && res.month_6 && res.month_7 && res.month_8 && res.month_9 && res.month_10 && res.month_11 && empty(res.month_12)){
                    $('#month_12').focus();
                }
