    ...
    <tbody>
        ...
        @foreach ($productionRecords as $productionRecord)
            <tr class="text-center">
                ...
                <td>{{ $productionRecord->animalInfo->tattoo_no }} </td>
                ...
                @isset($productionRecord->day_15)
                    <td>{{ number_format($productionRecord->day_15 - $productionRecord->animalInfo->birth_wt / 15, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_1)
                    <td>{{ number_format($productionRecord->month_1 - $productionRecord->animalInfo->birth_wt / 30, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_2)
                    <td>{{ number_format($productionRecord->month_2 - $productionRecord->animalInfo->birth_wt / 60, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_3)
                    <td>{{ number_format($productionRecord->month_3 - $productionRecord->animalInfo->birth_wt / 60, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_6)
                    <td>{{ number_format($productionRecord->month_6 - $productionRecord->animalInfo->birth_wt / 90, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_12)
                    <td>{{ number_format($productionRecord->month_12 - $productionRecord->animalInfo->birth_wt / 360, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_18)
                    <td>{{ number_format($productionRecord->month_18 - $productionRecord->animalInfo->birth_wt / 540, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_24)
                    <td>{{ number_format($productionRecord->month_24 - $productionRecord->animalInfo->birth_wt / 720, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_30)
                    <td>{{ number_format($productionRecord->month_30 - $productionRecord->animalInfo->birth_wt / 900, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_34)
                    <td>{{ number_format($productionRecord->month_36 - $productionRecord->animalInfo->birth_wt / 1080, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_42)
                    <td>{{ number_format($productionRecord->month_42 - $productionRecord->animalInfo->birth_wt / 1260, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @isset($productionRecord->month_48)
                    <td>{{ number_format($productionRecord->month_48 - $productionRecord->animalInfo->birth_wt / 1440, 2) }}
                    </td>
                @else
                    <td></td>
                @endisset
                ...
                @if ($editable == 1)
                    <td>
                        <div class="form-button-action">
                            <a href="{{ route('body-weight.edit', $productionRecord->id) }}" title="Edit"
