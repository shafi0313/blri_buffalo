        ...
        <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
            ...
            <li class="nav-item dropdown hidden-caret">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                    <div class="avatar-sm">
                        <img src="{{ asset('files/images/user/company_logo.jpg') }}" class="avatar-img rounded-circle">
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <li>
                        <div class="user-box">
                            <div class="avatar-lg">
                                @if (file_exists(asset('files/images/user/'.auth()->user()->profile_photo_path)))
                                <img src="{{ asset('files/images/user/'.auth()->user()->profile_photo_path) }}" class="avatar-img rounded">
                                @else
                                <img src="{{ asset('files/images/user/company_logo.jpg') }}" class="avatar-img rounded">
                                @endif
