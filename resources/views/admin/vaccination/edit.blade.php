                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('vaccination.update', $vaccine->id)}}" method="post">
                                @csrf @method('PUT')
                                <input type="hidden" name="type" id="type">

                                <div class="row">
                                    {{-- <div class="form-check col-md-3">
                                        <label>Vaccination Type <span class="t_r">*</span></label><br>
                                        <label class="form-radio-label">
                                            <input class="form-radio-input" type="radio" name="vac_type" value="single" id="single">
                                            <span class="form-radio-sign">Single</span>
                                        </label>
                                        <label class="form-radio-label ml-3">
                                            <input class="form-radio-input" type="radio" name="vac_type" value="group" id="group">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="vaccine_name" class="form-control @error('vaccine_name') is-invalid @enderror" name="vaccine_name" required>
                                            <option value="">Select</option>
                                            <option value="FMD" @selected($vaccine->vaccine_name=='FMD')>FMD</option>
                                            <option value="HS" @selected($vaccine->vaccine_name=='HS')>HS</option>
                                            <option value="BQ" @selected($vaccine->vaccine_name=='BQ')>BQ</option>
                                            <option value="Anthrax" @selected($vaccine->vaccine_name=='Anthrax')>Anthrax</option>
                                        </select>
                                        @error('vaccine_name')
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="date" class="form-control @error('vaccine_date') is-invalid @enderror" name="vaccine_date" value="{{$vaccine->vaccine_date}}">
                                        @error('vaccine_date')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('dose') is-invalid @enderror" name="dose" value="{{$vaccine->dose}}">
                                        @error('dose')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
