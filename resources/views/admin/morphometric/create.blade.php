                            ...
                            <form action="{{ route('morphometric.store')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="age" type="date" class="form-control @error('age') is-invalid @enderror" value="{{old('age')}}" required>
                                        @error('age')
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="body_lenght" type="number" step="any" class="form-control body_lenght @error('body_lenght') is-invalid @enderror" value="{{old('body_lenght')}}" required>
                                        @error('body_lenght')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="heart_girth" type="number" step="any" class="form-control heart_girth @error('heart_girth') is-invalid @enderror" value="{{old('heart_girth')}}" required>
                                        @error('heart_girth')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
